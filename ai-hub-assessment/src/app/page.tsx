      ...
      <div className="max-w-3xl space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-20">
          <div className="border border-border p-6">
            ...
            <h3 className="text-xl font-medium mb-2">Realistic Scenarios</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">Face true-to-life challenges mapping directly to daily AI usage.</p>
          </div>
          <div className="border border-border p-6">
            <div className="text-[#ff4e00] mb-4">
            ...
            <h3 className="text-xl font-medium mb-2">Four Dimensions</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">Evaluate Fact-Checking, Prompt Engineering, Security, and Tool Identification.</p>
          </div>
          <div className="border border-border p-6">
            <div className="text-[#ff4e00] mb-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">Immediate multi-axis feedback and targeted learning paths upon completion.</p>
          </div>
        </div>
      </div>
    </div>
