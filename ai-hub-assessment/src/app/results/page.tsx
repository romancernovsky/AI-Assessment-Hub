...
const ResultsRadarChart = dynamic(() => import('@/components/ResultsRadarChart'), {
  loading: () => <div className="flex justify-center mb-8"><div className="w-full max-w-md h-[320px] animate-pulse bg-muted" /></div>,
  ssr: false,
});
...
export default function Results() {
  ...
  const handleExportPdf = async () => {
    const { exportResultsPdf } = await import('@/lib/exportResultsPdf');
    exportResultsPdf({
      overallScore,
      badge,
      completionTime,
